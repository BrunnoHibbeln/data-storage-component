  ...
  return (
    <section className="flex w-full flex-col gap-10 rounded-xl rounded-tr-[130px] bg-blue p-10">
      ...
      <section className="flex flex-row gap-4">
        <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-dark-blue p-2">
          <Image src={DocumentIcon} alt="Document Icon" />
        </div>
        <div className="flex  h-12 w-12 items-center justify-center rounded-lg bg-dark-blue p-3">
